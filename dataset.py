...
spec_layer = Spectrogram.STFT(n_fft=2048, freq_bins=None, hop_length=512, window='hann', freq_scale='linear', center=True, pad_mode='reflect', 
							  fmin=50,fmax=11025, sr=44100) # Initializing the model
...
if __name__ == '__main__':
	...
	dataloader = DataLoader(
		AudioTransformSet("./Baseline_Data/Content/Joni_Mitchell/files.txt", 8192, 22050, augment=True))
