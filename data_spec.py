...
if __name__ == '__main__':
	...
	dataloader = DataLoader(
		AudioTransformSet("./Baseline_Data/Joni_Mitchell/files.txt", "./Baseline_Data/Nancy_Sinatra/files.txt", 441000, 22050, augment=True))

	for index, data in enumerate(dataloader):
		
		specgram = torchaudio.transforms.Spectrogram(n_fft=800)(data[1])
